...
import com.lear7.showcase.mvp.demo.DemoPresenter;
import com.lear7.showcase.mvp.demo.DemoView;

import butterknife.BindView;
import butterknife.OnClick;

@Route(path = Routers.Act_MvpDemo)
public class MvpDemoActivity extends BaseActivity implements DemoView {
